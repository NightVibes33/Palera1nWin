...
public partial class DowngradeView
{
    ...
    {
        InvalidatePreflight("Firmware path changed. The IPSW will be inspected when you start.");
        RefreshEnhancedActionState();
    }
    ...
    private void ExperienceFirmwareSelectionChanged(object sender, System.Windows.Controls.SelectionChangedEventArgs e)
    {
        ...
        {
            InvalidatePreflight("Firmware selection changed. Download or inspect it, then start when ready.");
        }
        RefreshEnhancedActionState();
    }
    ...
    private async void StartEnhancedDowngrade_Click(object sender, RoutedEventArgs e)
    {
        ...
        SetBusy(true, "Preparing downgrade", "Detecting the connected device and inspecting the selected IPSW.");
        RefreshEnhancedActionState();
        ...
        try
        {
            ...
            CurrentStageText.Text = "Starting downgrade";
            CurrentDetailText.Text = "Device and IPSW match. Preparing the Windows USB restore path.";
